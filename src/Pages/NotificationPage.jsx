      ...
      {notifications.map((notification) => (
        <div className="w-full flex justify-between p-2 max-w-[454px] " key={notification._id}>
          <div className="flex items-center gap-1 ">
            ...
            <div className="flex flex-wrap w-3/4 sm:w-auto gap-1 ">
              <h1 className="font-medium text-black text-xs sm:text-base">{notification.username} </h1>
              <h1 className="text-gray-600 text-xs font-medium sm:text-base"> {notification.content}</h1>
            </div>
          </div>
